...
use App\Helpers\EnumPermissoesGPUHelper;
use App\Helpers\UUIDsHelpers;
use Illuminate\Database\Seeder;
use Illuminate\Support\Facades\DB;

class PermissionSeederCopia extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $data = [
            array_merge(EnumPermissoesGPUHelper::DESENVOLVEDOR, ['created_user_id' => $adminId]),
            array_merge(EnumPermissoesGPUHelper::ADMINISTRADOR, ['created_user_id' => $adminId]),
            array_merge(EnumPermissoesGPUHelper::SUPORTE_GPU, ['created_user_id' => $adminId]),
