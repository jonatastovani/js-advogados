...
export class modalGeneroTenant extends modalSearchAndFormRegistration {
    ...
    #objConfigs = {
        ...
        querys: {
            consultaFiltros: {
                ...
                url: window.apiRoutes.baseGeneroTenant,
                urlSearch: `${window.apiRoutes.baseGeneroTenant}/consulta-filtros`,
            }
        },
    };
    ...
    */
    ...
    #addEventosPadrao() {
        ...
        const formDataSearchModalGeneroTenant = modal.find('#formDataSearchModalGeneroTenant');

        modal.find('.btn-new-register').on('click', async () => {
            self._updateTitleRegistration('Novo Gênero');
        });

        formDataSearchModalGeneroTenant.find('.btnBuscar').on('click', async (e) => {
            e.preventDefault();
