...
class PageUsuarioPFIndex extends templateSearch {
    ...
    #objConfigs = {
        ...
        url: {
            ...
            baseFrontPessoaFisicaUsuarioForm: window.frontRoutes.baseFrontPessoaFisicaUsuarioForm
        },
        data: {
            perfil_referencia_id: window.Enums.PessoaPerfilTipoEnum.USUARIO,
            perfis_busca: [
    ...
    constructor() {
        super({ sufixo: 'PageUsuarioPFIndex' });
    ...
    async insertTableData(item, options = {}) {
        ...
        $(tbody).append(`
            <tr id=${pessoaDados.idTr} data-id-perfil="${pessoaDados.pessoa_perfil_referencia.id}">
                ...
                <td class="text-nowrap text-truncate ${classCor}" title="${usuario}">${usuario}</td>
    ...
    #htmlBtns(pessoaDados) {
        ...
        let strBtns = `
            <li>
                <a href="${self._objConfigs.url.baseFrontPessoaFisicaUsuarioForm}/${pessoaDados.pessoa_perfil_referencia.id}" class="dropdown-item fs-6 btn-edit" title="Editar pessoa física ${pessoaDados.nome}.">
                    Editar
                </a>
            </li>
            <li>
