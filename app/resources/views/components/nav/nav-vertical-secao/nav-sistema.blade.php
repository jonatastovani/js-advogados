<li class="nav-item">
    <div class="nav-item-wrapper">
        <a class="nav-link dropdown-indicator collapsed" href="#nv-sistema" role="button" data-bs-toggle="collapse"
            aria-expanded="false" aria-controls="nv-configuracao">
        ...
        <div class="parent-wrapper">
            <ul class="nav parent collapse" id="nv-sistema" style="">
                <li class="nav-item">
