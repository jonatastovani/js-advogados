<li class="nav-item">
    <div class="nav-item-wrapper">
        <a class="nav-link dropdown-indicator collapsed" href="#nv-cliente" role="button" data-bs-toggle="collapse"
            aria-expanded="false" aria-controls="nv-cliente">
        ...
        <div class="parent-wrapper">
            <ul class="nav parent collapse" id="nv-cliente" style="">
                <li class="nav-item">
