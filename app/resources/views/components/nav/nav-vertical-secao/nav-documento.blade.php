<li class="nav-item">
    <div class="nav-item-wrapper">
        <a class="nav-link dropdown-indicator collapsed" href="#nv-doc-mod" role="button" data-bs-toggle="collapse"
            aria-expanded="false" aria-controls="nv-doc-mod">
        ...
        <div class="parent-wrapper">
            <ul class="nav parent collapse" id="nv-doc-mod">
                {{-- <li class="nav-item">
