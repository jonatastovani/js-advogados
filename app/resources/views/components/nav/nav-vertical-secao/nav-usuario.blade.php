<li class="nav-item">
    <div class="nav-item-wrapper">
        <a class="nav-link dropdown-indicator collapsed" href="#nv-usuario" role="button" data-bs-toggle="collapse"
            aria-expanded="false" aria-controls="nv-usuario">
        ...
        <div class="parent-wrapper">
            <ul class="nav parent collapse" id="nv-usuario" style="">
                <li class="nav-item">
