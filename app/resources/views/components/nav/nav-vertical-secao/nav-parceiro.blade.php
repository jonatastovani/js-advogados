<li class="nav-item">
    <div class="nav-item-wrapper">
        <a class="nav-link dropdown-indicator collapsed" href="#nv-parceiro" role="button" data-bs-toggle="collapse"
            aria-expanded="false" aria-controls="nv-parceiro">
        ...
        <div class="parent-wrapper">
            <ul class="nav parent collapse" id="nv-parceiro" style="">
                <li class="nav-item">
