        ...
        <div class="modal-content">
            ...
            <form class="modal-body formRegistration">
                <div class="row row-cols-1 row-cols-sm-2">
                    <div class="col">
                        <label for="data_vencimento{{ $sufixo }}" class="form-label">Data de
                            vencimento</label>
                    ...
                    <div class="col">
                        <label for="valor_esperado{{ $sufixo }}" class="form-label">Valor esperado</label>
                ...
                <div class="divInfoLancamentoPersonalizado"></div>
                <div class="row">
