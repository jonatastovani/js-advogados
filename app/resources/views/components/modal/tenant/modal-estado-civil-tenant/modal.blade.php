<div class="modal fade" id="ModalEstadoCivilTenant" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header py-1">
                <h4 class="modal-title">Estado Civil</h4>
            ...
            <div class="modal-body pt-1">
                ...
                <div class="divRegistrationFields mt-2" style="display: none;">
                    @include('components.modal.tenant.modal-estado-civil-tenant.campos-cadastro', [
                        'sufixo' => $sufixo,
                    ])
                </div>
            </div>
