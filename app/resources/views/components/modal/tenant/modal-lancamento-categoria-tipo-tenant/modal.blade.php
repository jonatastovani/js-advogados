<div class="modal fade" id="modalLancamentoCategoriaTipoTenant" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pt-1">
                ...
                <div class="divRegistrationFields mt-2" style="display: none;">
                    @include('components.modal.tenant.modal-lancamento-categoria-tipo-tenant.campos-cadastro', [
                        'sufixo' => $sufixo,
                    ])
                </div>
            </div>
