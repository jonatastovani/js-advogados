<div class="modal fade" id="modalGeneroTenant" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pt-1">
                ...
                <div class="divRegistrationFields mt-2" style="display: none;">
                    @include('components.modal.tenant.modal-genero-tenant.campos-cadastro', [
                        'sufixo' => $sufixo,
                    ])
                </div>
            </div>
