<div class="row">
    <div class="col mt-2">
        ...
        <span class="d-block">Porcentagem distribuída: <span id="porcentagem{{ $sufixo }}">0,00</span>%</span>
        <span class="d-block">Valor mínimo do lançamento para uso do preset: R$ <span
                id="valor_minimo{{ $sufixo }}">0,00</span></span>
    </div>
</div>

<div class="progress mt-2" role="progressbar" aria-label="Porcentagem distribuída" aria-valuenow="0" aria-valuemin="0"
    aria-valuemax="100">
