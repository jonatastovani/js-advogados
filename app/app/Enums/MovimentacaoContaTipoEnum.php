...
enum MovimentacaoContaTipoEnum: int
{
     ...
     *
     * @return array O tipo de movimentação contrária.
     */
    static public function tipoMovimentacaoContraria($id): array
    {
        return match ($id) {
            self::CREDITO->value => self::DEBITO->detalhes(),
            self::DEBITO->value => self::CREDITO->detalhes(),
        };
    }
}
