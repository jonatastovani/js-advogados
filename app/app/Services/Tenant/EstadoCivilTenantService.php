...
class EstadoCivilTenantService extends Service
{
    ...
    protected function verificacaoEPreenchimentoRecursoStoreUpdate(Fluent $requestData, $id = null): Model
    {
        ...
        if ($validacaoRecursoExistente->count() > 0) {
            $arrayErrors =  LogHelper::gerarLogDinamico(409, 'O nome informado para este estado civil já existe.', $requestData->toArray());
    ...
    public function buscarRecurso(Fluent $requestData, array $options = [])
    {
        return parent::buscarRecurso($requestData, [
            'message' => 'O Estado Civil não foi encontrado.',
        ]);
    }
