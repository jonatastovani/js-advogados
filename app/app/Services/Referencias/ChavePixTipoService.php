...
use App\Models\Referencias\ChavePixTipo;
use App\Services\Service;
use App\Traits\ConsultaSelect2ServiceTrait;
use Illuminate\Http\Request;
use Illuminate\Support\Fluent;

class ChavePixTipoService extends Service
{
    use ConsultaSelect2ServiceTrait;

    public function __construct(ChavePixTipo $model)
    {
    ...
    public function buscarRecurso(Fluent $requestData, array $options = [])
    {
        return parent::buscarRecurso($requestData, [
            'message' => 'O tipo de chave pix não foi encontrado.',
        ]);
    }
