...
class Pessoa extends Model
{
     ...
     */
    public static function scopeJoinReferenciaPessoaFisica(Builder $query, array $options = [])
    {
        ...
        return (new self())->scopeJoinWithConditions($query, PessoaFisica::getTableName(), "$aliasTable.pessoa_dados_id", "=", "{$envOptions->aliasJoin}.id", $envOptions->toArray());
    }
}
