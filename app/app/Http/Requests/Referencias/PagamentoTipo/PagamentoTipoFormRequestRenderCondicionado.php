...
class PagamentoTipoFormRequestRenderCondicionado extends PagamentoTipoFormRequestRenderBase
{
    ...
    {
        $pagamentoTipo = PagamentoTipo::find(PagamentoTipoEnum::CONDICIONADO->value);
        $rules = parent::rules();
