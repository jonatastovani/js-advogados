...
use App\Enums\ServicoParticipacaoReferenciaTipoEnum;
use App\Helpers\UUIDsHelpers;
use App\Traits\CommonsSeederMethodsTrait;
use Illuminate\Database\Seeder;

class ServicoParticipacaoReferenciaTipoSeeder extends Seeder
{
    ...
    {
        $insert = [];
        foreach (ServicoParticipacaoReferenciaTipoEnum::cases() as $enumValue) {
