...
use App\Services\GEPEN\ServidorPessoaGEPENService;
use Illuminate\Http\Request;

class ServidorPessoaGEPENController extends Controller
{
    protected $service;

    public function __construct(ServidorPessoaGEPENService $service)
    {
