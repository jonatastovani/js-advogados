<li class="nav-item">
    <div class="nav-item-wrapper">
        <a class="nav-link dropdown-indicator" href="#nv-geren-servico" role="button" data-bs-toggle="collapse"
            aria-expanded="true" aria-controls="nv-geren-servico">
        ...
        <div class="parent-wrapper">
            <ul class="nav parent collapse show" data-bs-parent="#navbarVerticalNav" id="nv-geren-servico" style="">
                <li class="nav-item">
