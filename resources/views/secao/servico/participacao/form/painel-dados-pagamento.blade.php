<div class="row text-end">
    ...
    <div class="col mt-2">
        <button type="button" class="btn btn-outline-primary btn-sm" id="btnInserirPagamento{{ $sufixo }}">Inserir Pagamento</button>
    </div>
</div>
<div id="divPagamento{{ $sufixo }}" class="row row-cols-1 g-2 mt-2"></div>
