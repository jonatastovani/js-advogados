...
export class modalServicoParticipacao extends modalRegistrationAndEditing {
    ...
    */
    ...
    //     // let data = { "participacao_tipo_id": "9d3b5146-a013-4544-ad6c-9a46587bac8d", "valor_total": 3000, "entrada_valor": 500, "entrada_data": "2024-10-18", "parcela_data_inicio": "2024-11-20", "parcela_quantidade": 7, "parcela_vencimento_dia": 10 };
    ...
    //             // const objModal = new modalServicoParticipacao(self.#objConfigs.url.basePagamentos);
    //             // objModal.setDataEnvModal = {
    //             //     idRegister: item.id,
    //             // }
    //             // const response = await objModal.modalOpen();
    ...
    //     const self = this;
    //     try {
    //         const objConn = new connectAjax(self._objConfigs.url.baseServicoParticipacaoTipoTenant);
    ...
    //             form.find('select[name="participacao_tipo_id"]').val(responseData.participacao_tipo_id);
    ...
    //     let blnSave = commonFunctions.verificationData(data.participacao_tipo_id, { field: formRegistration.find('select[name="participacao_tipo_id"]'), messageInvalid: 'A <b>Conta padrão</b> deve ser informada.', setFocus: true });
